const appCopy = {
  menu: {
    ...
    features: [
      ...
      "Перетаскивание изображений, чтобы менять очередь партий",
  ...
  howToPlay: {
    title: "Как играть",
    intro:
      "Правила простые: игра берёт картинку из общего пула по очереди, а после победы заранее подготавливает следующую партию.",
    quickStart:
      "Загрузите группу картинок на стартовом экране, при необходимости поменяйте их порядок, настройте размеры и цвета, затем нажмите «Начать».",
    steps: [
      {

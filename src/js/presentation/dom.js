export const menuPage = document.querySelector("#menuPage");
...
export const leadersSortSelect = document.querySelector("#leadersSort");
export const refreshLeadersButton = document.querySelector(
  "#refreshLeadersButton",
);
export const exportLeadersButton = document.querySelector(
  "#exportLeadersButton",
);
export const clearLeadersButton = document.querySelector("#clearLeadersButton");
export const leadersBody = document.querySelector("#leadersBody");
export const leadersStatusOutput = document.querySelector("#leadersStatus");

export const menuButton = document.querySelector("#menuButton");
export const gameSettingsButton = document.querySelector("#gameSettingsButton");
export const hintButton = document.querySelector("#hintButton");
export const orderButton = document.querySelector("#orderButton");
export const shuffleButton = document.querySelector("#shuffleButton");
export const gameFileName = document.querySelector("#gameFileName");
export const gameModeBadge = document.querySelector("#gameModeBadge");
export const gameGoalText = document.querySelector("#gameGoalText");
export const progressPercentOutput = document.querySelector("#progressPercent");
export const progressFill = document.querySelector("#progressFill");
export const placedPiecesValue = document.querySelector("#placedPiecesValue");
export const groupsValue = document.querySelector("#groupsValue");
export const scoreValue = document.querySelector("#scoreValue");
export const scoreHint = document.querySelector("#scoreHint");
export const piecesSummary = document.querySelector("#piecesSummary");
export const board = document.querySelector("#board");
export const timerOutput = document.querySelector("#timer");
export const statusOutput = document.querySelector("#status");

export const winModal = document.querySelector("#winModal");
export const winTime = document.querySelector("#winTime");
export const winScore = document.querySelector("#winScore");
export const winMode = document.querySelector("#winMode");
export const winPieces = document.querySelector("#winPieces");
export const winMessage = document.querySelector("#winMessage");
